...
const filters = [
  {
    ...
    name: 'Category',
    options: [
      { value: 'tees', label: 'Appliances' },
      { value: 'crewnecks', label: 'Furniture' },
      { value: 'hats', label: 'Garden' },
      { value: 'bundles', label: 'Textiles' },
      { value: 'carry', label: 'Electronics' },
      { value: 'objects', label: 'Sports equipment' },
    ],
  },
  {
    id: 'brand',
    name: 'Distance',
    options: [
      { value: 'clothing-company', label: '200m' },
      { value: 'fashion-inc', label: '400m' },
      { value: 'shoes-n-more', label: "800m" },
      { value: 'supplies-n-stuff', label: "1.2K" },
    ],
  },
  {
    id: 'color',
    name: 'Material',
    options: [
      { value: 'white', label: 'Wood' },
      { value: 'black', label: 'Metal' },
      { value: 'grey', label: 'Plastic' },
      { value: 'blue', label: 'Leather' },
      { value: 'olive', label: 'Fabric' },
      { value: 'tan', label: 'Glass' },
    ],
  },
  {
    id: 'sizes',
    ...
    options: [
      { value: 'xs', label: 'New' },
      { value: 's', label: 'Like new' },
      { value: 'm', label: 'Good' },
      { value: 'l', label: 'Fair' },
      { value: 'xl', label: 'Poor' },
      { value: '2xl', label: 'Broken' },
    ],
  },
]
const products1 = [
  {
    ...
    href: '#',
    price: '50 CHF',
    description: 'Dented, rusty, working',
    imageSrc: 'https://www.winkleightimber.co.uk/wp-content/uploads/2019/02/code_403ok-768x1024.jpg',
  ...
  },
  {
    ...
    href: '#',
    price: '30 CHF',
    description: 'Chipped, scratched, sturdy',
    imageSrc: 'https://www.songbirdblog.com/wp-content/uploads/outdoor-table-makeover-before-1.jpg',
  ...
  },
  {
    ...
    href: '#',
    price: '100 CHF',
    description: 'Stained, worn, comfortable',
    imageSrc: 'https://scontent.fzrh3-1.fna.fbcdn.net/v/t45.5328-4/335845325_8981239088584497_3338294669199376319_n.jpg?stp=dst-jpg_s960x960&_nc_cat=110&ccb=1-7&_nc_sid=c48759&_nc_ohc=jNTW3eQZ6LcAX-gzNXo&_nc_ht=scontent.fzrh3-1.fna&oh=00_AfCZsbwr4qhHWv4og9-YV-tmR-9-tArPnafp3qEzMx4k-Q&oe=64218702',
...
const products2 = [
  {
    ...
    href: '#',
    price: '20 CHF',
    description: 'Bent, squeaky, functional',
    imageSrc: 'https://static.songmics.com/fit-in/500x500/image/Product/URMB034BR/Vintage%20Metal%20Bed%20Frame%20with%20Headboard%20and%20Footboard%20URMB034BR-6.jpg',
    imageAlt: 'Close up of long kettle spout pouring boiling water into pour-over coffee mug with frothy coffee.',
  },
  {
    id: 8,
    name: 'Plastic garden chairs',
    href: '#',
    price: '10 CHF',
    description: 'Faded, cracked, stackable',
    imageSrc: 'https://for-sale.used-secondhand.co.uk/media/used/secondhand/images/61922/12x-plastic-chairs-winchester-hampshire/1200/black-and-white-patio-chairs-862.jpg',
    imageAlt:
  ...
  },
  {
    ...
    href: '#',
    price: '40 CHF',
    description: 'Dirty, torn, large',
    imageSrc: 'https://cdn.shopify.com/s/files/1/1281/1783/products/3073611crPersianQashqairug_1024x1024.jpg?v=1624970465',
    imageAlt:
                            ...
                            <h3 className="-mx-2 -my-3 flow-root">
                              <Disclosure.Button className="flex w-full items-center justify-between bg-white px-2 py-3 text-sm text-gray-400">
                                ...
                                <span className="ml-6 flex items-center">
                                  ...
                                  <AiFillCaretDown className={classNames(open ? '-rotate-180' : 'rotate-0', 'h-5 w-5 transform')}
                                    aria-hidden="true"
                                  />
                                </span>
                              </Disclosure.Button>
        ...
        <main>
          <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:max-w-7xl lg:px-8">
            <div className="py-24 text-center">
              <h1 className="text-4xl font-bold tracking-tight text-gray-900">Find new deals</h1>
              <p className="mx-auto mt-4 max-w-3xl text-base text-gray-500">
                previously loved objects for the workspace, home, or office. Enjoy them for a bargain.
              </p>
            </div>
                  ...
                  <a key={product.id} href={product.href} className="group">
                    <div className="aspect-w-1 aspect-h-1 overflow-hidden rounded-lg sm:aspect-w-2 sm:aspect-h-3">
                      <img
                        ...
                        className="h-80 w-96 object-cover object-center group-hover:opacity-75"
                      />
                    </div>
            ...
            <button type="button" className="block mx-auto w-full max-w-xs py-3 px-4 border border-transparent rounded-md shadow-sm text-base font-medium text-white bg-red-600 hover:bg-red-700 mb-10">See more products</button>
          </div>
        </main>
