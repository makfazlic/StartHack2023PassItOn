...
import {AiOutlineUser, AiOutlineShoppingCart, AiFillCaretDown} from 'react-icons/ai'
  ...
  categories: [
    {
      name: 'Thrift',
      featured: [
        { name: 'Find new objects', href: '/thrift' },
      ],
    },
    {
      name: 'Dispose',
      featured: [
        { name: 'Select your preferance', href: '/dispose' },
      ],
...
const offers = [
  { name: 'Easy and convenient', description: 'Find best solutions for your bulky waste within minutes', href: '#' },
  { name: "Eco-friendly and responsible", description: 'Recycle, sell, or donate bulky waste for environment', href: '#' },
  { name: 'Cost-effective and rewarding', description: 'Waste less, help more, save or make money', href: '#' },
]
const trendingProducts = [
  {
    id: 1,
    name: 'Leather sofa',
    color: 'Minor Scratches',
    price: '100 CHF',
    href: '#',
    imageSrc: 'https://www.new2you-furniture.com/images/listing_photos/156_cream_leather_sofa_c877.jpg',
  ...
  },
  {
    ...
    color: 'Dents and Rust',
    price: '50 CHF',
    href: '#',
    imageSrc: 'https://cdn.shopify.com/s/files/1/0637/3408/7922/products/IMG_3194.heic?v=1663564087&width=533',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
    ],
  },
  {
    ...
    color: 'Chips and Cracks on the Wood',
    price: '30 CHF',
    href: '#',
    imageSrc: 'https://scontent.fzrh3-1.fna.fbcdn.net/v/t45.5328-4/335944266_5704866212974226_6829747686021929267_n.jpg?stp=dst-jpg_s960x960&_nc_cat=108&ccb=1-7&_nc_sid=c48759&_nc_ohc=2kH9nCTeFfQAX-6KXCp&_nc_ht=scontent.fzrh3-1.fna&oh=00_AfB7aqVtU8kW1UZCXaIDI8F69aSz99hSle09kkO_cWVo8Q&oe=6421D4DA',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
    ],
  },
  {
    id: 4,
    name: 'Carpet',
    color: 'Lightly Stained',
    price: '15 CHF',
    href: '#',
    imageSrc: 'https://d2kjfkpnjd3d2z.cloudfront.net/eyJlZGl0cyI6eyJyZXNpemUiOnsiaGVpZ2h0IjowLCJiYWNrZ3JvdW5kIjoid2hpdGUiLCJ3aWR0aCI6MTc0OCwiZml0IjoiY29udGFpbiJ9fSwiYnVja2V0Ijoid2FudGRvbnR3YW50Iiwia2V5IjoicHJvZHVjdHMvaGVucnllcmxvZzA2MDYyMi9JTUctMjAyMjA1MTEtV0EwMDExLmpwZyJ9',
    imageAlt: 'Black machined steel pen with hexagonal grip and small white logo at top.',
    availableColors: [
    ],
  },
                    ...
                    <div className="flex items-center lg:ml-8">
                      ...
                      <div className="flow-root">
                        <a href="#" className="group -m-2 flex items-center p-2">
                          ...
                          <AiOutlineShoppingCart className="h-6 w-6 flex-shrink-0 text-gray-400 group-hover:text-gray-500" aria-hidden="true" />
        ...
        <div className="flex flex-col border-b border-gray-200 lg:border-0">
          ...
          <div className="relative">
              ...
              <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:grid lg:grid-cols-2 lg:px-8">
                <div className="mx-auto max-w-2xl py-24 lg:max-w-none lg:py-64">
                  <div className="lg:pr-16">
                    <img src={ logo_onwhite } alt="" className="h-12 mb-5" />
                    <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl xl:text-6xl mb-5">
                    Smart solution for bulky waste!
                    </h1>
                    <p className="mt-4 text-xl text-gray-600">
                    Connect with Recycling Companies and other Users who can take care of your unwanted items with just few clicks.
                    </p>
                    <div className="mt-6">
                      <a
                        href="#"
            ...
            <div className="h-48 w-full sm:h-64 lg:absolute lg:top-0 lg:right-0 lg:h-full lg:w-1/2">
              <img
                src="https://images.pexels.com/photos/6827156/pexels-photo-6827156.jpeg?auto=compress&cs=tinysrgb&w=1260&h=750&dpr=2"
                alt=""
        ...
        <section aria-labelledby="trending-heading" className="bg-white">
          <div className="py-16 sm:py-24 lg:mx-auto lg:max-w-7xl lg:py-32 lg:px-8">
                  ...
                  {trendingProducts.map((product) => (
                    <li key={product.id} className="inline-flex w-64 flex-col text-center lg:w-auto">
                      <div className="group relative">
                        <div className="aspect-w-1 aspect-h-1  rounded-md bg-gray-200">
                          <img
            ...
            <div className="mt-12 px-4 sm:hidden">
              <a href="#" className="text-sm font-semibold text-red-600 hover:text-red-500">
                See everything
                <span aria-hidden="true"> &rarr;</span>
              </a>
            </div>
        ...
        <div className="relative overflow-hidden mb-20">
          ...
          >
            <div className="mx-auto max-w-2xl lg:max-w-none">
              ...
              Refer a friend and get 50% off your next waste service.
              </h2>
              <p className="mx-auto mt-4 max-w-xl text-xl text-gray-600">
                A limited time offer, so act fast. We'll send you a code to share with your friends.
              </p>
              <a
                href="#"
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-x-6 xl:gap-x-8">
              ...
              <div className="relative mt-6 flex items-center py-12 px-6 sm:py-16 sm:px-10 lg:mt-0">
                <div className="absolute inset-0 overflow-hidden rounded-lg">
                  ...
                  />
                  <div className="absolute inset-0 bg-red-500 bg-opacity-90" />
                </div>
            ...
            <div className="mt-4 flex items-center justify-center md:mt-0">
              ...
              <div className="ml-6 border-l border-gray-200 pl-6">
                <a href="#" className="flex items-center text-gray-500 hover:text-gray-600">
                  <img
                    src="https://upload.wikimedia.org/wikipedia/commons/thumb/e/e7/Flag_of_Switzerland_-_2.svg/600px-Flag_of_Switzerland_-_2.svg.png?20110122134846"
                    alt=""
